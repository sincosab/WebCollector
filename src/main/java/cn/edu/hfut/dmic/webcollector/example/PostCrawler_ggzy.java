 ...
 * @author hu
 */
public class PostCrawler_ggzy extends BreadthCrawler {
    ...
    public PostCrawler_ggzy(final String crawlPath, boolean autoParse) {
...
//    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        PostCrawler_ggzy crawler = new PostCrawler_ggzy("json_crawler", true);
        crawler.start(1);
    }
