 ...
 * @author hu
 */
public class CcgpCrawler extends BreadthCrawler {
    ...
    */
    int count=0;
    public CcgpCrawler(String crawlPath, boolean autoParse) {
        super(crawlPath, autoParse);
        
        addSeed("http://www.ccgp.gov.cn/zcdt/index.htm");
       // addSeed("http://www.ccgp.gov.cn/zcdt/index_"+i+".htm");
        for (int i=1;i<5;i++) {
        addSeed("http://www.ccgp.gov.cn/zcdt/index_"+i+".htm");
        }
      // addSeed("http://www.ccgp.gov.cn/zcdt/index_2.htm");
        addRegex("http://www.ccgp.gov.cn/zcdt/.*/.*");
...
//        setExecuteInterval(1000);
    ...
    */
    ...
    public void visit(Page page, CrawlDatums next) {
        if (page.matchUrl("http://www.ccgp.gov.cn/zcdt/.*/.*")) {
           // String title = page.select("h1.title-article").first().text();
           // String author = page.select("a#uid").first().text();
           
           // System.out.println("title:" + title + "\tauthor:" + author);
            
            String content= page.select("div.vF_deail_maincontent").first().text();
    ...
    public static void main(String[] args) throws Exception {
        CcgpCrawler crawler = new CcgpCrawler("crawl", true);
